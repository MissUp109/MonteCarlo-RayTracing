...
private:
	...
	int m_ns;
public:
	Material(string mtype = "", Double3 mka = Double3(), Double3 mkd = Double3(), Double3 mks = Double3(), Double3 mtf = Double3(), double mni = 1, int mns = 0) :
		m_type(mtype), m_ka(mka), m_kd(mkd), m_ks(mks), m_tf(mtf), m_ni(mni), m_ns(mns) {}
