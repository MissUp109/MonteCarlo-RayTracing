...
void setScene(Scene &scene, Camera &camera, int sceneNum) {
	...
	case 1: {
		...
		camera.setCamera(400, 400, Double3(0, 5, 30), Double3(0, 5, 5), 15.0);
		break;
	}
	case 2: {
		...
		camera.setCamera(400, 400, Double3(2, 4, 15), Double3(2, 5, 5), 15);
		break;
	}
	case 3: {
		mtlPath = ROOT + "Scenes/myScene.mtl";
		objPath = ROOT + "Scenes/myScene.obj";
		Material lightMat("lambert", Double3(25.0, 25.0, 25.0), Double3(0.5, 0.5, 0.5));
		scene.Add(dynamic_cast<Object *>(new Model(mtlPath, objPath)));
